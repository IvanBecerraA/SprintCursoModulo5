 ...
 */
@WebServlet(name = "SvUsuario", urlPatterns = {"/SvUsuario", "/update", "/delete"})
    ...
    private void delete(HttpServletRequest request, HttpServletResponse response) throws SQLException, IOException {
        ...
        */
            ...
            if (botonFormulario != "" && botonFormulario != null) {
                ...
                int idTipo = Integer.parseInt(request.getParameter("floatingSelect"));//recuperando id tipo usuario
                String nombre = (request.getParameter("nombre"));
                String apellido1 = (request.getParameter("apellido1"));
                String apellido2 = (request.getParameter("apellido2"));
                String password = (request.getParameter("contrasenia"));
                DateTimeFormatter formatter = DateTimeFormatter.ofPattern("yyyy-MM-dd");
                LocalDate fechaNacimiento = LocalDate.parse(request.getParameter("fechaNac"), formatter);
                ...
                switch (tipoUsuario) {
                    case "Cliente":
                        ...
                        cli.setApellido2(apellido2); cli.setContrasenia(password);
                    ...
                    case "Administrativo":
                        ...
                        adm.setNombre(nombre); adm.setApellido1(apellido1);
