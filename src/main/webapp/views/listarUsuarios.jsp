...
<table class="table mb-0">
    ...
    <%
        ...
        ArrayList<Usuario> usuarios = (ArrayList<Usuario>)request.getAttribute("usuariosHtml");
    ...
    <tr class="text-center align-middle">
        <td class="fw-bold"><%=x.getIdUsuario() %></td>
        <td><%=x.getNombre() %></td>
        ...
        <td class="align-middle">
            <form class="mb-0" action="/../SprintCursoModulo5/usuario?option=update&amp;id_usuario=<%=x.getIdUsuario() %>&amp;tipoUsuario=<%=tipoUsuario %>" method="POST"><!--actualizar-->
            <button type="submit" class="btn btn-success" name="actualizarFormulario" value="Editar"><i class="bi bi-pencil-square"></i></button>
        </form></td>
        <td class="align-middle"><form class="mb-0" action="/../SprintCursoModulo5/usuario?option=delete&amp;id_usuario=<%=x.getIdUsuario()%>&amp;tipoUsuario=<%=tipoUsuario%>" method="POST"><!--eliminar-->
